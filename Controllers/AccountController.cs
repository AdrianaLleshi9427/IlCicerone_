...
namespace IlCicerone.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            ViewData["CountryNameList"] = countryList.Select(x => new SelectListItem
            {
            ...
            ViewData["CityNameList"] = cityList.Select(x => new SelectListItem
            {
            ...
            ViewData["LanguageNameList"] = languageList.Select(x => new SelectListItem
            {
